...
AdaptiveSamplingContext loadAdaptiveSamplingContext(ivec2 pixelCoord)
{
    ...
    context.hasHistory = (pushConstants.frame > 0) && (pushConstants.isMoving == 0);
