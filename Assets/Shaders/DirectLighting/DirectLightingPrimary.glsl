#ifndef DIRECTLIGHTING_PRIMARY_GLSL
#define DIRECTLIGHTING_PRIMARY_GLSL

void primaryRayGenDirect(ivec2 pixelCoord, ivec2 screenSize)
{
    ...
    generatePrimaryRay(
        pixelCoord, screenSize, sceneSettings.camera, samplerState,
        true, !isInteractiveFrame(), rayOrigin, rayDirection);
...
#ifdef USE_COMPUTE
    traceRayComputeDirect(rayOrigin, rayDirection, 0.001, 1000.0, payload);
#else
...
#endif // DIRECTLIGHTING_PRIMARY_GLSL
